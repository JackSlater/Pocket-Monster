...
var ASM_CONSTS = {
  4417712: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4417767: ($0) => { performance.now = function() { return $0; }; },  
 4417815: ($0) => { performance.now = function() { return $0; }; },  
 4417863: () => { performance.now = Module['emscripten_get_now_backup']; }
};
